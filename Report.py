...
def set_chrome_options(user_data_dir, chrome_binary_path):
...
def main():
    ...
    driver.set_window_position(-850, 1355)# 设置浏览器窗口位置（x, y）
    ...
    try:
        ...
        for uid in uids:
            try:
                ...
                if 'data' in data and 'archives' in data['data'] and len(data['data']['archives']) > 0:# 检查返回数据是否包含 archives
                        ...
                        if skip == 9:
                            ...
                            while True:
                                try:
                                    ...
                                    try:# 等待 'geetest_item_wrap' 元素消失，表示验证码验证成功
